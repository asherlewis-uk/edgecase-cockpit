...
_Previous mismatch findings (2026-06-15) are superseded by the real-user-account migration. This report now serves as the source-backed verification that the required architecture is in place._
