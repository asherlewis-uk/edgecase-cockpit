...
This project is indexed by GitNexus as **edgecase-cockpit** (2458 symbols, 6015 relationships, 200 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
